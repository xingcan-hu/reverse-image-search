...
export const SiteFooter = ({ locale }: { locale: string }) => {
  ...
  return (
    <footer className="border-t border-[var(--ui-line)] bg-white/78 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-6 text-sm text-[var(--ui-muted)] sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
        <div>
